...
class StatTable:
    ...
    def computeCalculations(self):
        ...
        output += "no numbers       "+ str(len(self.no_number_distinct))+ "      " + str((floor((len(self.unfiltered_distinct) - len(self.no_number_distinct)) / (len(self.unfiltered_distinct)))))+ "%      " + str((floor((len(self.unfiltered_distinct) - len(self.no_number_distinct)) / (len(self.no_number_distinct))))) + "%      " + str(len(self.no_number)) +  "      " + str((floor((len(self.unfiltered) - len(self.no_number)) / (len(self.unfiltered))))) + "%      "  + str((floor((len(self.unfiltered) - len(self.no_number)) / (len(self.unfiltered))))) + "%\n"
        output += "30 stop words       "+ str(len(self._30_stop_words_distinct))+ "      " + str((floor((len(self.no_number_distinct) - len(self._30_STOP_WORDS)) / (len(self.no_number_distinct)))))+ "%      " + str(floor((len(self.no_number_distinct) - len(self._30_stop_words_distinct)) / (len(self._30_stop_words_distinct)))) + "%      " + str(len(self._30_stop_words)) + "      " + str((floor((len(self.no_number) - len(self._30_stop_words)) / (len(self.no_number))))) + "%      "  + str((floor((len(self.no_number) - len(self._30_stop_words)) / (len(self._30_stop_words))))) + "%\n"
        output += "150 stop words       "+ str(len(self._150_stop_words_distinct))+ "      " + str((floor((len(self._30_stop_words_distinct) - len(self._150_stop_words_distinct)) / (len(self._30_stop_words_distinct)))))+ "%      " + str((floor((len(self._30_stop_words_distinct) - len(self._150_stop_words_distinct)) / (len(self._150_stop_words_distinct))))) + "%      " + str(len(self._150_stop_words)) + "      " + str((floor((len(self._30_stop_words) - len(self._150_stop_words)) / (len(self._30_stop_words))))) + "%      "  + str((floor((len(self._30_stop_words) - len(self._150_stop_words)) / (len(self._150_stop_words))))) + "%\n"
